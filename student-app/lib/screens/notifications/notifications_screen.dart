    ...
    return Scaffold(
      ...
      body: _isLoading
          ...
          : _notifications.isEmpty
              ? const Center(child: Text('No new notifications', style: TextStyle(color: AppTheme.textSecondary)))
              : ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Container(
                      color: notif.isRead ? Colors.transparent : AppTheme.stone.withValues(alpha: 0.3),
                      child: ListTile(
